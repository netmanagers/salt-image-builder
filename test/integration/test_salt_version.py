...
def test_salt_version(host, saltvers, installmethod):
    ...
    pep440_format = r"3002\+0na." + git_sha_regex
    master_format = r"3002-n/a-" + git_sha_regex
    ...
    if saltvers == "master":
        ...
        saltvers = pep440_format + r"|" + master_format
        ...
        saltvers = pep440_format + r"|" + tiamat_format + r"|" + major_minor
    else:
